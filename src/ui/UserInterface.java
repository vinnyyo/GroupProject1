...
public class UserInterface {
    ...
    /**
     * Enrolls a member to the store
     * Requires Name, Address, Phone Number, Fees Paid. Sets the join date to the current date.
     */
     ...
     * Requests the id of the member, if member is found, they are removed
     */
     ...
     * Requires Product name, id, stock price and reorder level
     */
    ...
    /**
     * Checkout member at the counter.
     * Gets a list of product and quantity to order
     */
    ...
    /**
     * Changes the price of a product in the store
     * Requires product id
     */
    ...
    private void getProductInfo() {
    	...
    	while (iterator.hasNext()) {
    		...
    		if (curResult.getProductName().contains(searchString)) {
	    		System.out.println(curResult.getProductName() + " " +
	    					curResult.getProductId() + " " +
	    					curResult.getProductPrice() + " " +
	    					curResult.getProductStock() + " " +
    ...
    private void getMemberInfo() {
    	...
    	while (iterator.hasNext()) {
    		...
    		if (curResult.getMemberName().contains(searchString)) {
	    		System.out.println(curResult.getMemberName() + " " +
	    					curResult.getMemberAddress() + " " +
	    					curResult.getMemberFees() + " " +
	    					curResult.getMemberId());
    		}
    	}
    }
